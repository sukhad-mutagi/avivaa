...
describe('Controller Tests', function () {
    ...
    describe('CgHealthCheckController', function () {
        var $scope, jhiHealthService; // actual implementations
        var createController; // local utility functions

        beforeEach(inject(function ($injector, CgHealthService) {
            $scope = $injector.get('$rootScope').$new();
            jhiHealthService = CgHealthService;
            var locals = {
                '$scope': $scope
            };
            createController = function() {
                $injector.get('$controller')('CgHealthCheckController as vm', locals);
            };
            createController();
        }));
